...
|---|---|---|
| `SKILL.md:10` | Intro: "ask questions one at a time to refine the idea" | Amend for batching — one of **four** sites carrying this framing |
...
| `SKILL.md:314-324` | `## Key Principles` | Amend the "One question at a time" principle |
...
| Batching amended everywhere | No stale one-at-a-time instruction survives at `:10`, `:28`, `:264`, `:266`, or in Key Principles |
