...
Verbatim port of the upstream `skills/adhd/SKILL.md` from
[UditAkhourii/adhd](https://github.com/UditAkhourii/adhd) (MIT, Udit
Akhouri). Preprint: [adhdstack.github.io](https://adhdstack.github.io/).
Upstream LICENSE preserved at `UPSTREAM-LICENSE`. See
[issue #1](https://github.com/zpyoung/quirk/issues/1) for the
incorporation discussion. Companion docs:

- `frames.md` — the 15 cognitive frames reference
- `reference/when-to-use.md` — use/don't-use catalog
- `reference/divergence-prompts.md` — copy-paste generator + critic prompts
- `SOURCE-SPEC.md` — original divergent-ideation spec

When brainstorming gets stuck on the option space, the
[`brainstorming`](../brainstorming/SKILL.md) skill may advise invoking
this skill as a subroutine; ADHD remains opt-in and is not a mandatory
step in the brainstorming flow.
